...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <a href="<?= e($base) ?>/" class="nav-item <?= $activeNav === 'dashboard' ? 'is-active' : '' ?>">
            <span class="nav-icon">📊</span> Dashboard
        </a>
        <a href="<?= e($base) ?>/deals" class="nav-item <?= $activeNav === 'deals' ? 'is-active' : '' ?>">
            <span class="nav-icon">📁</span> Deale
        </a>
        <a href="<?= e($base) ?>/activities" class="nav-item <?= $activeNav === 'activities' ? 'is-active' : '' ?>">
